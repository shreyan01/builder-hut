import AstroLogo from "../logos/LandingPage/AstroLogo";
import OpenAILogo from "../logos/LandingPage/OpenAILogo";
import PrismaLogo from "../logos/LandingPage/PrismaLogo";
import SalesforceLogo from "../logos/LandingPage/SalesforceLogo";
